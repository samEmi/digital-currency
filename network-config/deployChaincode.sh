...
setGlobalsForPeer0Org2() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/crypto-config/peerOrganizations/msb2.example.com/peers/peer0.msb2.example.com/msp
    # export CORE_PEER_MSPCONFIGPATH=${PWD}/crypto-config/peerOrganization/msb2.example.com/users/Admin@msb2.example.com/msp
...
setGlobalsForPeer0Org3() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/crypto-config/peerOrganization/msb3.example.com/users/Admin@msb3.example.com/msp
...
setGlobalsForPeer0Org4() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/crypto-config/peerOrganization/msb4.example.com/users/Admin@msb4.example.com/msp
...
setGlobalsForPeer0Org5() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/crypto-config/peerOrganization/msb5.example.com/users/Admin@msb5.example.com/msp
